...
class __TwigTemplate_52f2c6f81436a2c3b6c93d4423317acd40d3b05bf555d741820300ed65885e1b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        // line 86
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 86), "get", [0 => "journal3_home_h1"], "method", false, false, false, 86)) {
            // line 87
            echo "  <h1 class=\"sr-only\" style=\"position: absolute; height: 1px; width: 1px; clip: rect(0,0,0,0);\">";
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 87), "get", [0 => "journal3_home_h1"], "method", false, false, false, 87);
            echo "</h1>
";
        }
        // line 89
...
";
        // line 90
        if (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 90), "get", [0 => "oldBrowserStatus"], "method", false, false, false, 90)) {
            // line 91
            echo "<div class=\"old-browser\">
  <div class=\"ob-content\">
    <h2 class=\"ob-title\">";
            // line 93
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 93), "get", [0 => "oldBrowserTitle"], "method", false, false, false, 93);
            echo "</h2>
    <span class=\"ob-text\">";
            // line 94
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 94), "get", [0 => "oldBrowserText"], "method", false, false, false, 94);
            echo "</span>
    <div class=\"ob-links\">
      <a href=\"https://www.google.com/chrome/\" target=\"_blank\" rel=\"nofollow\">
        <img src=\"";
            // line 97
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 97), "get", [0 => "oldBrowserChrome"], "method", false, false, false, 97);
            echo "\" alt=\"Chrome\" />
      ...
      <a href=\"https://www.mozilla.org/firefox/new/\" target=\"_blank\" rel=\"nofollow\">
        <img src=\"";
            // line 101
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 101), "get", [0 => "oldBrowserFirefox"], "method", false, false, false, 101);
            echo "\" alt=\"Firefox\" />
      ...
      <a href=\"https://www.microsoft.com/en-us/windows/microsoft-edge\" target=\"_blank\" rel=\"nofollow\">
        <img src=\"";
            // line 105
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 105), "get", [0 => "oldBrowserEdge"], "method", false, false, false, 105);
            echo "\" alt=\"edge\" />
      ...
      <a href=\"https://www.opera.com/\" target=\"_blank\" rel=\"nofollow\">
        <img src=\"";
            // line 109
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 109), "get", [0 => "oldBrowserOpera"], "method", false, false, false, 109);
            echo "\" alt=\"opera\" />
      ...
      <a href=\"https://www.apple.com/lae/safari/\" target=\"_blank\" rel=\"nofollow\">
        <img src=\"";
            // line 113
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 113), "get", [0 => "oldBrowserSafari"], "method", false, false, false, 113);
            echo "\" alt=\"safari\" />
...
";
        // line 121
        if ( !twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 121), "isPopup", [], "method", false, false, false, 121)) {
            // line 122
            echo "<div class=\"mobile-container mobile-main-menu-container\">
  <div class=\"mobile-wrapper-header\">
    <span>";
            // line 124
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 124), "get", [0 => "headerMobileMenuTitle"], "method", false, false, false, 124);
            echo "</span>
    ";
            // line 125
            if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 125), "get", [0 => "mobileLangPosition"], "method", false, false, false, 125) == "menu")) {
                // line 126
                echo "      <div class=\"language-currency top-menu\">
        <div class=\"mobile-currency-wrapper\">
            ";
                // line 128
                echo ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 128), "hasClass", [0 => "mobile-header-active"], "method", false, false, false, 128)) ? (($context["currency"] ?? null)) : (""));
                echo "
        </div>
        <div class=\"mobile-language-wrapper\">
            ";
                // line 131
                echo ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 131), "hasClass", [0 => "mobile-header-active"], "method", false, false, false, 131)) ? (($context["language"] ?? null)) : (""));
                echo "
        </div>
      </div>
    ";
  ...
  <div class=\"mobile-main-menu-wrapper\">
    ";
            // line 138
            echo (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 138), "isPhone", [], "method", false, false, false, 138) || (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "document", [], "any", false, false, false, 138), "isTablet", [], "method", false, false, false, 138) && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 138), "get", [0 => "mobileHeaderOn"], "method", false, false, false, 138) == "tablet")))) ? (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 138), "get", [0 => "mobile_main_menu"], "method", false, false, false, 138)) : (""));
            echo "
  </div>
</div>
...
<div class=\"mobile-container mobile-cart-content-container\">
  <div class=\"mobile-wrapper-header\">
    <span>";
            // line 149
            echo twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 149), "get", [0 => "headerMobileCartTitle"], "method", false, false, false, 149);
            echo "</span>
    <a class=\"x\"></a>
  </div>
...
";
        // line 156
        echo twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "loadController", [0 => "journal3/layout", 1 => "popup"], "method", false, false, false, 156);
        echo "
...
<div class=\"site-wrapper\">
  ...
  ";
        // line 160
        echo twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "loadController", [0 => "journal3/layout", 1 => "header_notice"], "method", false, false, false, 160);
        echo "
";
        // line 174
        echo "  ";
        $this->loadTemplate((("journal3/template/journal3/headers/desktop/" . twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 174), "get", [0 => "headerType"], "method", false, false, false, 174)) . ".twig"), "journal3/template/common/header.twig", 174)->display($context);
        // line 175
        echo "
  ";
        // line 176
        echo twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "loadController", [0 => "journal3/layout", 1 => "fullscreen_slider"], "method", false, false, false, 176);
        echo "
";
    }
    ...
    {
        return array (  416 => 176,  413 => 175,  410 => 174,  406 => 160,  399 => 156,  396 => 155,  387 => 149,  373 => 138,  368 => 135,  361 => 131,  355 => 128,  351 => 126,  349 => 125,  345 => 124,  341 => 122,  339 => 121,  336 => 120,  326 => 113,  319 => 109,  312 => 105,  305 => 101,  298 => 97,  292 => 94,  288 => 93,  284 => 91,  282 => 90,  279 => 89,  273 => 87,  271 => 86,  266 => 84,  258 => 78,  253 => 76,  251 => 75,  238 => 73,  234 => 72,  228 => 70,  226 => 69,  221 => 67,  218 => 66,  210 => 64,  206 => 63,  195 => 61,  191 => 60,  179 => 57,  173 => 55,  171 => 54,  167 => 53,  160 => 50,  153 => 47,  151 => 46,  149 => 45,  143 => 43,  141 => 42,  136 => 41,  131 => 39,  129 => 38,  115 => 35,  111 => 34,  109 => 33,  103 => 31,  101 => 30,  95 => 28,  93 => 27,  88 => 24,  86 => 23,  82 => 22,  78 => 21,  74 => 20,  56 => 15,  53 => 14,  39 => 2,  37 => 1,);
    }
