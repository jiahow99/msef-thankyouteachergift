...
class __TwigTemplate_7967401d45f1976d3702fb7db37911b59c26ebe74f8896c071ffe45eb58169eb extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["j3"] ?? null), "settings", [], "any", false, false, false, 7), "get", [0 => "pageTitlePosition"], "method", false, false, false, 7) == "top")) {
            // line 8
            echo "  <h1 class=\"title page-title greenboard\"><span>";
